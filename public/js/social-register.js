document.addEventListener('DOMContentLoaded', function() {
    ...
    function switchPages() {
        ...
        next.addEventListener('click', function () {
            ...
            let social_provider_id = document.getElementById('social_provider_id').value;
            let phone = document.getElementById('phone').value;
            let valid_data = true;

            errors_display.innerHTML = '';

            if(username.trim() === '' || email.trim() === '' ||  city.trim() === '' || profession.trim() === '' || phone.trim() === '' ){
            ...
            if(valid_data){
                ...
                document.getElementById('register_btn').addEventListener('click',function (){
                    ...
                    formData.append('social_provider_id', social_provider_id);
                    ...
                    $.ajax({
                        url : '/auth/social/artisan/register',
                        type : 'POST',
                        dataType : 'json',
                        processData : false,
                        contentType : false ,
