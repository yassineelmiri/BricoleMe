    ...
    <div id="register_choice" class="absolute w-full h-full inset-0 bg-gray-700 backdrop-filter bg-opacity-50 backdrop-blur-md z-20 flex items-center justify-center hidden">
        <div class="relative px-[1.5rem] py-[3rem] rounded-lg bg-slate-100 flex justify-center">
            <div class="absolute top-0 left-0 bg-orange-400 rounded-t-lg w-full h-[30px] flex justify-end items-center">
                <img id="close_btn" src="<?php echo e(asset('images/close.png')); ?>" class="w-[22.5px] h-[22.5px] cursor-pointer mr-[0.75rem]" alt="">
            </div>
            <div class="ml-[2.5rem] flex items-center justify-center gap-[3rem]">
                <div class="flex flex-col gap-[0.75rem]">
                    ...
                    <button class="px-[0.5rem] py-[0.25rem] text-white font-medium bg-indigo-500 rounded-lg hover:bg-indigo-400"><a href="<?php echo e(route('artisan.register.view')); ?>">AN artisan</a></button>
                </div>
                <div class="flex flex-col gap-[0.75rem]">
                    <img src="<?php echo e(asset('images/customer.png')); ?>" class="w-[150px] h-[150px] rounded-full " alt="">
                    <p class="text-center font-medium text-gray-600">Register As </p>
                    <button class="px-[0.5rem] py-[0.25rem] text-white font-medium bg-orange-500 rounded-lg hover:bg-orange-400"><a href="<?php echo e(route('customer.register.view')); ?>">A customer</a></button>
                </div>
                <div></div>
            </div>
        </div>
...
<script defer src="<?php echo e(asset('js/login.js')); ?>"></script>

<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/auth/login.blade.php ENDPATH**/ ?>