                    ...
                    <tbody>
                        <tr>
                            <td
                                ...
                                <span class="ml-3 font-bold text-white"> client </span>
                            </td>
                            <td
                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs p-4 text-left items-center  whitespace-nowrap p-4">
                                <img src="https://demos.creative-tim.com/notus-js/assets/img/bootstrap.jpg"
                                    class="inline-flex h-12 w-12 bg-white rounded-full border" alt="...">

                                    <span class="inline-flex ml-3 font-bold text-white"> artisan </span>

                            </td>
                            <td
                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                <i class="fas fa-circle text-orange-500 mr-2"></i>message
                            </td>
                            <td
                                class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                <div class="flex">
                            ...
                            <td
                                ...
                                <div class="flex gap-2 items-center">
                                    <a class="px-4 py-2 bg-amber-400 rounded-lg hover:bg-amber-300" href="">delete claim</a>
                                    <a class="px-4 py-2  bg-amber-400 rounded-lg hover:bg-amber-300" href="">fire artisan</a>
                                </div>
                            </td>
